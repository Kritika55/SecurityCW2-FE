...
const Contact = () => {
    const handleSubmit = (event) => {
        ...
        fetch("https://formspree.io/f/xqazaaqq", {
          method: "POST",
                    ...
                    <div className="w-1/2 px-4">
                        <div className="mb-12">
                            ...
                            <p className="mb-9 text-base leading-relaxed text-body-color">
                             Whether you have questions about our services, need assistance with a reservation,
                              or require support during your rental period, feel free to reach out to us through any of the methods below.
                            </p>
