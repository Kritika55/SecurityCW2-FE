...
const AdminUpdate = () => {
    ...
    useEffect(() => {
        getSingleProduct(id).then((res) => {
            ...
            setProductName(res.data.product.productEngine)
            setProductName(res.data.product.productMileage)
            setProductName(res.data.product.productOccupancy)
            ...
            <div className='container mt-3'>
                ...
                <div className='d-flex gap-3'>
                    <form action="">
                        ...
                        <input value={productEngine} onChange={(e) => setEngine(e.target.value)} className='form-control' type="text" placeholder='Enter your vehicle engine' />

                        <label htmlFor="">Mileage</label>
                        <input value={productMileage} onChange={(e) => setMileage(e.target.value)} className='form-control' type="text" placeholder='Enter your vehicle mileage' />

                        <label htmlFor="">Occupancy</label>
                        <input value={productOccupancy} onChange={(e) => setOccupancy(e.target.value)} className='form-control' type="text" placeholder='Enter vehicle occupancy' />
                        ...
                        <select value={productCategory} onChange={(e) => setProductCategory(e.target.value)} className='form-control'>
                            <option value="plants">Car</option>
                            <option value="electronics">Bike</option>
                            <option value="gadgets">Scooter</option>
                            <option value="furniture">Suv</option>
                        </select>
